  ...
  return (
    <div className="h-16 bg-gradient-to-r from-blue-500 to-purple-600 z-50 flex items-center sticky top-0">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        {/* FIX: Added flexbox to the Link to align the image and text side-by-side */}
        <Link to="/" className="flex items-center gap-2">
          {/* FIX: Made the image self-closing and added height classes */}
          <img src="/images/img2.png" alt="PS Linky Logo" className="h-8 w-auto sm:mt-0 mt-2" />
        ...
        <ul
          ...
          }  transition-all duration-100 sm:h-fit sm:bg-none bg-gradient-to-r from-blue-500 to-purple-600 sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
        >
