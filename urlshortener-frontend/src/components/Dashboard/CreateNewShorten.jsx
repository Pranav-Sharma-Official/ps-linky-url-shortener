...
const CreateNewShorten = ({ setOpen, refetch }) => {
  ...
  return (
    ...
    <form
        ...
        className="sm:w-[450px] w-[360px] relative shadow-[0_0_15px_rgba(0,0,0,0.3)] pt-8 pb-5 sm:px-8 px-4 rounded-lg"
      >

        {/* Replaced font-montserrat */}
        ...
        {/* Replaced bg-custom-gradient and removed undefined bg-customRed */}
        <button
          className="font-semibold text-white w-32 bg-gradient-to-r from-blue-500 to-purple-600 py-2 transition-colors rounded-md my-3"
          type="text"
        >
